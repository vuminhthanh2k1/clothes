import { Statistic } from "../../codegen/api/fetch/api";
import { PersistedModelStatic } from "../helpers/loopback";

module.exports = function (Statistic: PersistedModelStatic<Statistic>) {
  (Statistic as any).statisticClothes = async function (ctx: any) {
